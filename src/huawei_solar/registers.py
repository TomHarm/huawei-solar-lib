...
#TODO: change specific registers to value, here the None would be wrong.
SMARTLOGGER_REGISTERS = {
    rn.SMARTLOGGER_DATE_TIME: U32Register(None, 1, 40000),
    rn.SMARTLOGGER_CITY: U32Register(None, 1, 40002),
    rn.SMARTLOGGER_DAYLIGHT_SAVING_TIME_DST: U16Register(None, 1, 40004),
    rn.SMARTLOGGER_TIME_ZONE: I32Register("s", 1, 40005),
    rn.SMARTLOGGER_DST_STATE: U16Register(None, 1, 40007),
    rn.SMARTLOGGER_DST_OFFSET: U16Register("mins", 1, 40008),
    rn.SMARTLOGGER_LOCAL_TIME: U32Register(None, 1, 40009),
    rn.SMARTLOGGER_PV_INVERTER_SHUTDOWN: U16Register(None, 1, 40196),
    rn.SMARTLOGGER_PV_INVERTER_STARTUP: U16Register(None, 1, 40197),
    rn.SMARTLOGGER_ESS_SHUTDOWN: U16Register(None, 1, 40198),
    rn.SMARTLOGGER_ESS_STARTUP: U16Register(None, 1, 40199),
    rn.SMARTLOGGER_STARTUP: U16Register(None, 1, 40200),
    rn.SMARTLOGGER_SHUTDOWN: U16Register(None, 1, 40201),
    rn.SMARTLOGGER_STARTUP_SHUTDOWN: U16Register(None, 1, 40202),
    rn.SMARTLOGGER_STARTUP_SHUTDOWN: U16Register(None, 1, 40203),
    rn.SMARTLOGGER_TRANSFER_TRIP: U16Register(None, 1, 40204),
    rn.SMARTLOGGER_ARRAY_RESET: U16Register(None, 1, 40205),
    rn.SMARTLOGGER_QUANTITY_OF_RUNNING_PV_INVERTERS: U16Register(None, 1, 40206),
    rn.SMARTLOGGER_QUANTITY_OF_RUNNING_ESS_PCSS: U16Register(None, 1, 40207),
    rn.SMARTLOGGER_ESS_END_OF_DISCHARGE_SOC: U16Register("%", 10, 40217),
    rn.SMARTLOGGER_ESS_END_OF_CHARGE_SOC: U16Register("%", 10, 40218),
    rn.SMARTLOGGER_ACTIVE_PV_POWER_ADJUSTMENT_IN_FIXED_VALUE: U32Register("kW", 10, 40378),
    rn.SMARTLOGGER_ACTIVE_PV_POWER_ADJUSTMENT_IN_PERCENTAGE: U16Register("%", 10, 40380),
    rn.SMARTLOGGER_ACTIVE_ESS_POWER_ADJUSTMENT_IN_FIXED_VALUE: I32Register("kW", 10, 40381),
    rn.SMARTLOGGER_ACTIVE_ESS_POWER_ADJUSTMENT_IN_PERCENTAGE: I16Register("%", 10, 40383),
    rn.SMARTLOGGER_REACTIVE_PV_POWER_ADJUSTMENT_IN_FIXED_VALUE: I32Register("kVar", 10, 40384),
    rn.SMARTLOGGER_REACTIVE_ESS_POWER_ADJUSTMENT_IN_FIXED_VALUE: I32Register("kVar", 10, 40386),
    rn.SMARTLOGGER_ACTIVE_PV_POWER: U32Register("kW", 1000, 40388),
    rn.SMARTLOGGER_REACTIVE_PV_POWER: I32Register("kVar", 1000, 40390),
    rn.SMARTLOGGER_ACTIVE_ESS_POWER: I32Register("kW", 1000, 40392),
    rn.SMARTLOGGER_REACTIVE_ESS_POWER: I32Register("kVar", 1000, 40394),
    rn.SMARTLOGGER_RATED_PV_POWER: U32Register("kW", 1000, 40396),
    rn.SMARTLOGGER_RATED_ESS_POWER: U32Register("kW", 1000, 40398),
    rn.SMARTLOGGER_MAXIMUM_ACTIVE_PV_POWER_ADJUSTMENT_VALUE: U32Register("kW", 1000, 40400),
    rn.SMARTLOGGER_MAXIMUM_REACTIVE_PV_POWER_ADJUSTMENT_VALUE: U32Register("kVar", 1000, 40402),
    rn.SMARTLOGGER_MINIMUM_REACTIVE_PV_POWER_ADJUSTMENT_VALUE: I32Register("kVar", 1000, 40404),
    rn.SMARTLOGGER_MAXIMUM_REACTIVE_ESS_POWER_ADJUSTMENT_VALUE: U32Register("kVar", 1000, 40406),
    rn.SMARTLOGGER_MINIMUM_REACTIVE_ESS_POWER_ADJUSTMENT_VALUE: I32Register("kVar", 1000, 40408),
    rn.SMARTLOGGER_MINIMUM_ACTIVE_POWER_ADJUSTMENT_VALUE: I32Register("kW", 10, 40412),
    rn.SMARTLOGGER_ACTIVE_POWER_ADJUSTMENT: I32Register("kW", 10, 40420),
    rn.SMARTLOGGER_REACTIVE_POWER_ADJUSTMENT: I32Register("kVar", 10, 40422),
    rn.SMARTLOGGER_ACTIVE_POWER_ADJUSTMENT: U32Register("kW", 10, 40424),
    rn.SMARTLOGGER_REACTIVE_POWER_ADJUSTMENT: I32Register("kVar", 10, 40426),
    rn.SMARTLOGGER_ACTIVE_POWER_ADJUSTMENT_IN_PERCENTAGE: I16Register("%", 10, 40428),
    rn.SMARTLOGGER_POWER_FACTOR_ADJUSTMENT: I16Register(None, 1000, 40429),
    rn.SMARTLOGGER_ACTIVE_POWER_ADJUSTMENT_HIGHEST_PRIORITY: I32Register("kW", 1000, 40430),
    rn.SMARTLOGGER_REACTIVE_POWER_ADJUSTMENT_HIGHEST_PRIORITY: I32Register("kVar", 1000, 40432),
    rn.SMARTLOGGER_POWER_SUPPLY_FROM_GRID_TODAY: U32Register("kWh", 100, 40438),
    rn.SMARTLOGGER_TOTAL_POWER_SUPPLY_FROM_GRID: I64Register("kWh", 100, 40464),
    rn.SMARTLOGGER_ENERGY_CHARGED_TODAY: U32Register("kWh", 100, 40468),
    rn.SMARTLOGGER_ENERGY_DISCHARGED_TODAY: U32Register("kWh", 100, 40470),
    rn.SMARTLOGGER_TOTAL_ENERGY_CHARGED: I64Register("kWh", 100, 40472),
    rn.SMARTLOGGER_TOTAL_ENERGY_DISCHARGE_D: I64Register("kWh", 100, 40476),
    rn.SMARTLOGGER_CHARGEABLE_CAPACITY: U32Register("kWh", 1000, 40480),
    rn.SMARTLOGGER_DISCHARGEABLE_CAPACITY: U32Register("kWh", 1000, 40482),
    rn.SMARTLOGGER_RATED_ESS_CAPACITY: U32Register("kWh", 1000, 40484),
    rn.SMARTLOGGER_MAXIMUM_ESS_CHARGE_POWER: U32Register("kW", 1000, 40490),
    rn.SMARTLOGGER_MAXIMUM_ESS_DISCHARGE_POWER: U32Register("kW", 1000, 40492),
    rn.SMARTLOGGER_HIGHEST_STABLE_CHARGE_POWER_OF_ESS: U32Register("kW", 1000, 40494),
    rn.SMARTLOGGER_HIGHEST_STABLE_DISCHARGE_POWER_OF_ESS: U32Register("kW", 1000, 40496),
    rn.SMARTLOGGER_DC_CURRENT: I16Register("A", 10, 40500),
    rn.SMARTLOGGER_SOC: U16Register("%", 10, 40515),
    rn.SMARTLOGGER_SOH: U16Register("%", 10, 40516),
    rn.SMARTLOGGER_SOE: U16Register("%", 10, 40517),
    rn.SMARTLOGGER_RATED_ESS_CAPACITY_IN_AH: U32Register("Ah", 10, 40518),
    rn.SMARTLOGGER_INPUT_POWER: U32Register("kW", 1000, 40521),
    rn.SMARTLOGGER_CO2_REDUCED: U32Register("kg", 10, 40523),
    rn.SMARTLOGGER_ACTIVE_POWER: I32Register("kW", 1000, 40525),
    rn.SMARTLOGGER_POWER_FACTOR: I16Register(None, 1000, 40532),
    rn.SMARTLOGGER_ARRAY_IN_OPERATION: U16Register(None, 1, 40535),
    rn.SMARTLOGGER_ARRAY_SHUT_DOWN: U16Register(None, 1, 40536),
    rn.SMARTLOGGER_PV_INVERTER_IN_OPERATION: U16Register(None, 1, 40537),
    rn.SMARTLOGGER_PV_INVERTER_SHUT_DOWN: U16Register(None, 1, 40538),
    rn.SMARTLOGGER_ESS_PCS_IN_OPERATION: U16Register(None, 1, 40539),
    rn.SMARTLOGGER_ESS_PCS_SHUT_DOWN: U16Register(None, 1, 40540),
    rn.SMARTLOGGER_PLANT_STATUS: U16Register(None, 1, 40541),
    rn.SMARTLOGGER_PLANT_STATUS: U16Register(None, 1, 40542),
    rn.SMARTLOGGER_PLANT_STATUS: U16Register(None, 1, 40543),
    rn.SMARTLOGGER_REACTIVE_POWER: I32Register("kVar", 1000, 40544),
    rn.SMARTLOGGER_CO2_REDUCED: U64Register("kg", 100, 40550),
    rn.SMARTLOGGER_DC_CURRENT_2: I32Register("A", 10, 40554),
    rn.SMARTLOGGER_TOTAL_ENERGY_YIELD: U32Register("kWh", 10, 40560),
    rn.SMARTLOGGER_YIELD_TODAY: U32Register("kWh", 10, 40562),
    rn.SMARTLOGGER_TODAYS_POWER_GENERATION_HOURS: U32Register("h", 10, 40564),
    rn.SMARTLOGGER_PLANT_STATUS: U16Register(None, 1, 40566),
    rn.SMARTLOGGER_PLANT_STATUS: U16Register(None, 1, 40567),
    rn.SMARTLOGGER_ACTIVE_ALARM_SEQUENCE_NUMBER: U32Register(None, 1, 40568),
    rn.SMARTLOGGER_HISTORICAL_ALARM_SEQUENCE_NUMBER: U32Register(None, 1, 40570),
    rn.SMARTLOGGER_PHASE_A_CURRENT_OF_GRID: I16Register("A", 1, 40572),
    rn.SMARTLOGGER_PHASE_B_CURRENT_OF_GRID: I16Register("A", 1, 40573),
    rn.SMARTLOGGER_PHASE_C_CURRENT_OF_GRID: I16Register("A", 1, 40574),
    rn.SMARTLOGGER_A_B_LINE_VOLTAGE_OF_GRID: U16Register("V", 10, 40575),
    rn.SMARTLOGGER_B_C_LINE_VOLTAGE_OF_GRID: U16Register("V", 10, 40576),
    rn.SMARTLOGGER_C_A_LINE_VOLTAGE_OF_GRID: U16Register("V", 10, 40577),
    rn.SMARTLOGGER_STATUS_INFORMATION: U16Register(None, 1, 40578),
    rn.SMARTLOGGER_RESERVED: U16Register(None, 1, 40608),
    rn.SMARTLOGGER_INVERTER_EFFICIENCY: U16Register("%", 100, 40685),
    rn.SMARTLOGGER_MAXIMUM_REACTIVE_POWER_ADJUSTMENT_VALUE: U32Register("kVar", 10, 40693),
    rn.SMARTLOGGER_MINIMUM_REACTIVE_POWER_ADJUSTMENT_VALUE: I32Register("kVar", 10, 40695),
    rn.SMARTLOGGER_MAXIMUM_ACTIVE_POWER_ADJUSTMENT_VALUE: I32Register("kW", 10, 40697),
    rn.SMARTLOGGER_LOCKING_STATUS: U16Register(None, 1, 40699),
    rn.SMARTLOGGER_DI_GROUP_STATE: U16Register(None, 1, 40700),
    rn.SMARTLOGGER_EQUIPMENT_SERIAL_NUMBER_ESN: StringRegister(None, 1, 40713),
    rn.SMARTLOGGER_SYSTEM_RESET: U16Register(None, 1, 40723),
    rn.SMARTLOGGER_FAST_DEVICE_ACCESS: U16Register(None, 1, 40724),
    rn.SMARTLOGGER_DEVICE_OPERATION: 0(None, 1, 40725),
    rn.SMARTLOGGER_DEVICE_ACCESS_STATUS: U16Register(None, 1, 40736),
    rn.SMARTLOGGER_ACTIVE_POWER_CONTROL_MODE: U16Register(None, 1, 40737),
    rn.SMARTLOGGER_ACTIVE_POWER_SCHEDULING_TARGET_VALUE: I32Register("kW", 10, 40738),
    rn.SMARTLOGGER_REACTIVE_POWER_CONTROL_MODE: U16Register(None, 1, 40740),
    rn.SMARTLOGGER_REACTIVE_POWER_SCHEDULING_CURVE_MODE: U16Register(None, 1, 40741),
    rn.SMARTLOGGER_REACTIVE_POWER_SCHEDULING_TARGET_VALUE: I32Register("kVar", 10, 40742),
    rn.SMARTLOGGER_ACTIVE_POWER_SCHEDULING_IN_PERCENTAGE: I32Register("%", 1, 40802),
    rn.SMARTLOGGER_CO2_EMISSION_REDUCTION_COEFFICIENT: U16Register("kg/k Wh", 1000, 41124),
    rn.SMARTLOGGER_ACTIVE_POWER_CONTROL_MODE: U16Register(None, 1, 41889),
    rn.SMARTLOGGER_PV_MODULE_CAPACITY: U32Register("kW", 1000, 41934),
    rn.SMARTLOGGER_RATED_PLANT_CAPACITY: U32Register("kW", 1000, 41936),
    rn.SMARTLOGGER_TOTAL_RATED_CAPACITY_OF_GRID_TIED_INVERTERS: U32Register("kW", 1000, 41938),
    rn.SMARTLOGGER_CONVERSION_COEFFICIENT: U32Register(None, 1000, 41940),
    rn.SMARTLOGGER_COMMUNICATION_STATUS: U16Register(None, 1, 41942),
    rn.SMARTLOGGER_SHUT_DOWN_ARRAY_UPON_COMMUNICATION_TIMEOUT: U16Register(None, 1, 41947),
    rn.SMARTLOGGER_TIME_FOR_COMMUNICATION_EXCEPTION_DETECTION: U16Register("s", 1, 41948),
    rn.SMARTLOGGER_START_UP_ARRAY_UPON_COMMUNICATION_RECOVERY: U16Register(None, 1, 41949),
    rn.SMARTLOGGER_SYSTEM_TIME_YEAR: U16Register(None, 1, 42017),
    rn.SMARTLOGGER_SYSTEM_TIME_MONTH: U16Register(None, 1, 42018),
    rn.SMARTLOGGER_SYSTEM_TIME_DAY: U16Register(None, 1, 42019),
    rn.SMARTLOGGER_SYSTEM_TIME_HOUR: U16Register(None, 1, 42020),
    rn.SMARTLOGGER_SYSTEM_TIME_MINUTE: U16Register(None, 1, 42021),
    rn.SMARTLOGGER_SYSTEM_TIME_SECOND: U16Register(None, 1, 42022),
    rn.SMARTLOGGER_CURRENT_ERROR_DURING_SCANNING: U16Register(None, 100, 42150),
    rn.SMARTLOGGER_WORKING_MODE: U16Register(None, 1, 42256),
    rn.SMARTLOGGER_THE_ACTIVE_POWER_GRADIENT_REGISTER: U32Register("%/s", 1000, 42728),
    rn.SMARTLOGGER_INSPECTION_CONTROL: U16Register(None, 1, 42730),
    rn.SMARTLOGGER_I_V_CURVE_SCANNING: U16Register(None, 1, 42779),
    rn.SMARTLOGGER_REACTIVE_POWER_CONTROL_MODE: U16Register(None, 1, 44165),
    rn.SMARTLOGGER_ARRAY_BLACK_START: U16Register(None, 1, 44360),
    rn.SMARTLOGGER_ARRAY_BLACK_START_STATUS: U16Register(None, 1, 44361),
    rn.SMARTLOGGER_PV_ARRAY_PCS_WORKING_MODE: U16Register(None, 1, 44365),
    rn.SMARTLOGGER_PCS_WORKING_MODE: U16Register(None, 1, 44365),
    rn.SMARTLOGGER_VOLTAGE_ADJUSTMENT_VALUE_FOR_VSG_SYNCHRONOUS_CONTROL: I16Register("%", 100, 44366),
    rn.SMARTLOGGER_FREQUENCY_ADJUSTMENT_VALUE_FOR_VSG_SYNCHRONOUS_CONTROL: I16Register("%", 100, 44367),
    rn.SMARTLOGGER_POWER_ON_THE_PCS_OF_THE_SUBARRAY: U16Register(None, 1, 44373),
    rn.SMARTLOGGER_SHUT_DOWN_THE_PCS_OF_THE_SUBARRAY: U16Register(None, 1, 44374),
    rn.SMARTLOGGER_SUBARRAY_PV_INVERTER_MICROGRID_ADAPTABILITY: U16Register(None, 1, 44375),
    rn.SMARTLOGGER_ALARM_1: U16Register(None, 1, 50000),
    rn.SMARTLOGGER_ALARM_2: U16Register(None, 1, 50001),
    rn.SMARTLOGGER_ALARM_3: U16Register(None, 1, 50002),
    rn.SMARTLOGGER_ALARM_4: U16Register(None, 1, 50003),
    rn.SMARTLOGGER_ALARM_5: U16Register(None, 1, 50004),
    rn.SMARTLOGGER_ALARM_6: U16Register(None, 1, 50005)
}

SMARTLOGGER_POWER_METER_REGISTERS = {
    rn.SMARTLOGGER_EXTERNAL_METER_PHASE_A_VOLTAGE: U32Register("V", 100, 32260),
    rn.SMARTLOGGER_EXTERNAL_METER_PHASE_B_VOLTAGE: U32Register("V", 100, 32262),
    rn.SMARTLOGGER_EXTERNAL_METER_PHASE_C_VOLTAGE: U32Register("V", 100, 32264),
    rn.SMARTLOGGER_EXTERNAL_METER_A_B_LINE_VOLTAGE: U32Register("V", 100, 32266),
    rn.SMARTLOGGER_EXTERNAL_METER_B_C_LINE_VOLTAGE: U32Register("V", 100, 32268),
    rn.SMARTLOGGER_EXTERNAL_METER_C_A_LINE_VOLTAGE: U32Register("V", 100, 32270),
    rn.SMARTLOGGER_EXTERNAL_METER_PHASE_A_CURRENT: I32Register("A", 10, 32272),
    rn.SMARTLOGGER_EXTERNAL_METER_PHASE_B_CURRENT: I32Register("A", 10, 32274),
    rn.SMARTLOGGER_EXTERNAL_METER_PHASE_C_CURRENT: I32Register("A", 10, 32276),
    rn.SMARTLOGGER_EXTERNAL_METER_ACTIVE_POWER: I32Register("kW", 1000, 32278),
    rn.SMARTLOGGER_EXTERNAL_METER_REACTIVE_POWER: I32Register("kVa r", 1000, 32280),
    rn.SMARTLOGGER_EXTERNAL_METER_ACTIVE_ELECTRICITY: I32Register("kW h", 10, 32282),
    rn.SMARTLOGGER_EXTERNAL_METER_POWER_FACTOR: I16Register(None, 1000, 32284),
    rn.SMARTLOGGER_EXTERNAL_METER_REACTIVE_ELECTRICITY: I32Register("kvar h", 10, 32285),
    rn.SMARTLOGGER_EXTERNAL_METER_APPARENT_POWER: I32Register("kVA", 1000, 32287),
    rn.SMARTLOGGER_EXTERNAL_METER_POSITIVE_ACTIVE_ELECTRICITY: I32Register("kW h", 100, 32289),
    rn.SMARTLOGGER_EXTERNAL_METER_POSITIVE_REACTIVE_ELECTRICITY: I32Register("kvar h", 100, 32291),
    rn.SMARTLOGGER_EXTERNAL_METER_ELECTRICITY_IN_POSITIVE_ACTIVE_ELECTRICITY_PRICE_SEGMENT_1: I32Register("kW h", 100, 32299),
    rn.SMARTLOGGER_EXTERNAL_METER_ELECTRICITY_IN_POSITIVE_ACTIVE_ELECTRICITY_PRICE_SEGMENT_2: I32Register("kW h", 100, 32301),
    rn.SMARTLOGGER_EXTERNAL_METER_ELECTRICITY_IN_POSITIVE_ACTIVE_ELECTRICITY_PRICE_SEGMENT_3: I32Register("kW h", 100, 32303),
    rn.SMARTLOGGER_EXTERNAL_METER_ELECTRICITY_IN_POSITIVE_ACTIVE_ELECTRICITY_PRICE_SEGMENT_4: I32Register("kW h", 100, 32305),
    rn.SMARTLOGGER_EXTERNAL_METER_ELECTRICITY_IN_NEGATIVE_ACTIVE_ELECTRICITY_PRICE_SEGMENT_1: I32Register("kW h", 100, 32307),
    rn.SMARTLOGGER_EXTERNAL_METER_ELECTRICITY_IN_NEGATIVE_ACTIVE_ELECTRICITY_PRICE_SEGMENT_2: I32Register("kW h", 100, 32309),
    rn.SMARTLOGGER_EXTERNAL_METER_ELECTRICITY_IN_NEGATIVE_ACTIVE_ELECTRICITY_PRICE_SEGMENT_3: I32Register("kW h", 100, 32311),
    rn.SMARTLOGGER_EXTERNAL_METER_ELECTRICITY_IN_NEGATIVE_ACTIVE_ELECTRICITY_PRICE_SEGMENT_4: I32Register("kW h", 100, 32313),
    rn.SMARTLOGGER_EXTERNAL_METER_CUSTOM_1: I32Register(None, 1000, 32315),
    rn.SMARTLOGGER_EXTERNAL_METER_CUSTOM_2: I32Register(None, 1000, 32317),
    rn.SMARTLOGGER_EXTERNAL_METER_CUSTOM_3: I32Register(None, 1000, 32319),
    rn.SMARTLOGGER_EXTERNAL_METER_CUSTOM_4: I32Register(None, 1000, 32321),
    rn.SMARTLOGGER_EXTERNAL_METER_CUSTOM_5: I32Register(None, 1000, 32323),
    rn.SMARTLOGGER_EXTERNAL_METER_CUSTOM_6: I32Register(None, 1000, 32325),
    rn.SMARTLOGGER_EXTERNAL_METER_CUSTOM_7: I32Register(None, 1000, 32327),
    rn.SMARTLOGGER_EXTERNAL_METER_CUSTOM_8: I32Register(None, 1000, 32329),
    rn.SMARTLOGGER_EXTERNAL_METER_CUSTOM_9: I32Register(None, 1000, 32331),
    rn.SMARTLOGGER_EXTERNAL_METER_CUSTOM_10: I32Register(None, 1000, 32333),
    rn.SMARTLOGGER_EXTERNAL_METER_PHASE_A_ACTIVE_POWER: I32Register("kW", 1000, 32335),
    rn.SMARTLOGGER_EXTERNAL_METER_PHASE_B_ACTIVE_POWER: I32Register("kW", 1000, 32337),
    rn.SMARTLOGGER_EXTERNAL_METER_PHASE_C_ACTIVE_POWER: I32Register("kW", 1000, 32339),
    rn.SMARTLOGGER_EXTERNAL_METER_TOTAL_ACTIVE_ELECTRICITY: I64Register("kW h", 100, 32341),
    rn.SMARTLOGGER_EXTERNAL_METER_TOTAL_REACTIVE_ELECTRICITY: I64Register("kvar h", 100, 32345),
    rn.SMARTLOGGER_EXTERNAL_METER_NEGATIVE_ACTIVE_ELECTRICITY: I64Register("kW h", 100, 32349),
    rn.SMARTLOGGER_EXTERNAL_METER_NEGATIVE_REACTIVE_ELECTRICITY: I64Register("kvar h", 100, 32353),
    rn.SMARTLOGGER_EXTERNAL_METER_POSITIVE_ACTIVE_ELECTRICITY: I64Register("kW h", 100, 32357),
    rn.SMARTLOGGER_EXTERNAL_METER_POSITIVE_REACTIVE_ELECTRICITY: I64Register("kvar h", 100, 32361),
